...
from ultralytics.nn.modules.Impove.Dysample import DySample
from ultralytics.nn.modules.Impove.bifpn import Concat_BiFPN,Concat_BiFPN3
from ultralytics.nn.modules import SimSPPF,SimConv
from ultralytics.nn.modules.Impove.SimSPPF import BiFusion
...
def parse_model(d, ch, verbose=True):
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in base_modules:
            ...
            args = [ch[f], *args[0:]]
        elif m is [Concat_BiFPN, Concat_BiFPN3]:
